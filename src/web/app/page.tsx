    ...
    <main>
      ...
      <footer className="site-footer">
        <div className="site-container footer-inner">
          ...
          <div className="footer-meta"><p className="footer-copyright">© 2026 EVH Consult</p><nav className="footer-policy-links" aria-label="Privacy and cookie controls"><button type="button" className="evh-cookie-settings" data-cookie-settings>Cookie settings</button><a href="https://evhconsult.eu/privacy.html" data-privacy-link>Privacy &amp; cookies</a></nav></div><div className="footer-right"><nav className="footer-links" aria-label="Footer navigation"><a href="https://evhconsult.eu">EVH Consult</a><a href="https://ada.evhconsult.eu">Ada</a><a href="https://erwin.evhconsult.eu">Erwin</a><a href="https://github.com/EVH-Consult/ai.evhconsult.eu">GitHub</a><a href="https://evhconsult.eu/contact.html?source=ai.evhconsult.eu&path=%2F">Contact</a></nav><div className="footer-social" aria-label="EVH Consult AI/R&D social links"><a className="social-link" href="https://x.com/EVHConsultAI" aria-label="EVH Consult AI/R&D on X" title="EVH Consult AI/R&D on X">𝕏</a></div></div></div></footer>
    </main>
  );
}
